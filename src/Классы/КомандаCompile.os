...
Процедура РазобратьФайлыИнструкций(Знач Путь, Знач КаталогИнструкций, Знач КаталогИсходников)
	...
	Для Каждого Файл Из Файлы Цикл
		...
		ИначеЕсли Расширение = "md" Тогда
			ПреобразоватьMarkdown(Файл.ПолноеИмя, КаталогИнструкций, КаталогИсходников);
		КонецЕсли;
...
Процедура СкопироватьВложенныеРисунки(Знач КаталогИсточник, Знач КаталогИнструкций, Знач КаталогИсходников)
...
Процедура ПреобразоватьMarkdown(Знач ИмяФайла, Знач КаталогИнструкций, Знач КаталогИсходников)
